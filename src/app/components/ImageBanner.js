        ...
        <>
            ...
            <div className="relative flex items-center justify-center mb-20">
                <Image
                    ...
                    alt="Blog Image"
                />
                <div className="absolute top-[89%] left-[40%] transform -translate-x-1/2 -translate-y-1/2 max-w-[420px] p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
