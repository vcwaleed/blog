    ...
    return (
        <footer className="bg-gray-100">
            <div className="container mx-auto py-10 px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <div className='text-gray-500'>
                        ...
                        <p>Email: talha@info.net</p>

                        <p>Phone: 000 123 456 789</p>
                    </div>
                </div>

                <div className='sm:ml-16 ml-1'>
                ...
                <div className='bg-white p-4 rounded'>
                    ...
                    <form>
                        <input type="email" placeholder="Your Email" className="w-full px-4 py-2 border rounded mb-4" />
            ...
            <div className="border-t border-gray-200 p-4 grid sm:grid-cols-2 grid-cols-1 gap-4">
                <span className="text-center sm:text-left sm:pl-16">&copy; talhawaleed. All Rights Reserved.</span>
                <div className="text-center sm:text-right sm:pr-[122px]">
